export const APP_STATE = {
  ...
  ADDRESS_BOOK: 26, // address book
  SELECT_BOOK: 27, // address book
  DAPP: 28, // address book
...
// export const API_URL = 'https://vtest.infragrid.v.network';
export const API_URL = 'https://vpioneer.infragrid.v.network';

// visionscan官网地址
export const VISIONSCAN_URL = 'https://www.visionscan.org';

// vtest测试地址
// export const VTEST_URL = 'https://vtest.infragrid.v.network';
export const VTEST_URL = 'https://vpioneer.infragrid.v.network';
// vpioneer测试链
// export const vpioneer_URL = 'https://vtest.infragrid.v.network';
export const vpioneer_URL = 'https://vpioneer.infragrid.v.network';
export const vpioneer_SCAN_URL = 'https://www.visionscan.org';
export const vpioneer_FACUT_URL = 'https://vpioneerfaucet.visionscan.org';

export const mainnet_URL = 'https://infragrid.v.network';
export const mainnet_SCAN_URL = 'https://www.visionscan.org';

// 代币地址
export const ASSETS_TOKEN_URL = 'http://3.133.104.255:8090';
